    ...
    for r in rows:
        ...
        if key not in cache or data_date > cache[key].get("data_date", ""):
            cache[key] = {
                ...
                "region": region,
                "value": r.get("value", ""),
                "value_or_fact": r.get("value_or_fact", ""),
                "text_value": r.get("text_value", ""),
                "unit": r.get("unit", ""),
                "data_type": r.get("data_type", DT_ACTUAL),
                "season": r.get("season", "2025/2026"),
...
def fetch_china_msweet_production(target_date: str) -> list[dict]:
    ...
    for key, info in cache_freshness.items():
        ...
        results.append({
            ...
            "value_or_fact": info.get("value_or_fact", "") or info.get("text_value", ""),
            "text_value": info.get("text_value", ""),
            "unit": info.get("unit", ""),
            ...
            "data_type": info.get("data_type", DT_ACTUAL),
            "target_contract": TARGET_CONTRACT,
            "season": info.get("season", "2025/2026"),
            "status": ST_CACHED,
